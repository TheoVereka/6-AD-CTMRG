...
MY_OUTPUT_OUTERDIR = '/scratch/chye/0507core'
USE_GPU = False
...
CHI_MIN_LIST  = [ 10, 21, 32, 45, 60, 77, 96, 117,120]
CHI_MAX_LIST  = [ 14, 27, 40, 55, 72, 91,112,135,140]
...
import core_Jed as _core
from core_Jed import (
    normalize_tensor,
...
def main():
    ...
    if True: #USE_ADAM_WARMUP_THEN_LBFGS:
        print(f"  Optimizer: Adam warmup \u2192 L-BFGS "
              f"(flat-plateau switch over {ADAM_FLAT_PATIENCE} steps, spread < 6e-5)")
