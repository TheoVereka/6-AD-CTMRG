# 2C3 three-direction ordinary correlation-length cluster bundle
...
The output schema is `three_geometric_straight_rows_ordinary_v5`.  Every
...
The command may be rerun after a partial batch; valid completed v5 results
are skipped.
...
from repeated `scp -r` is harmless), validates the v5 schema and manifest
