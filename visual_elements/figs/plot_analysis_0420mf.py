...
OUT_DIR    = os.path.join(SCRIPT_DIR, 'analysis_plots_0420mf')
os.makedirs(OUT_DIR, exist_ok=True)

# ──────────────────────────────────────────────────────────────────────────────
# JOB → FOLDER MAP  (from node-jobid.log + Output dir in .out files)
# ──────────────────────────────────────────────────────────────────────────────
# job  2843490 (0p20mf)  → MF-init two-C3  J2=0.20
# job  2843491 (0p21mf)  → MF-init two-C3  J2=0.21
# job  2843492 (0p22mf)  → MF-init two-C3  J2=0.22
# job  2843493 (0p23mf)  → MF-init two-C3  J2=0.23
# job  2843494 (0p24mf)  → MF-init two-C3  J2=0.24
# job  2843495 (0p25mf)  → MF-init two-C3  J2=0.25
# job  2843448 (0p20two) → vanilla two-C3  J2=0.20
# job  2843449 (0p21two) → vanilla two-C3  J2=0.21
# job  2843450 (0p22two) → vanilla two-C3  J2=0.22
# job  2843451 (0p23two) → vanilla two-C3  J2=0.23
# job  2843452 (0p24two) → vanilla two-C3  J2=0.24
# job  2843453 (0p25two) → vanilla two-C3  J2=0.25
# job  2843489 (0p20mf1t)→ MF-init 1C6Ypi  J2=0.20

FOLDER_MAP = {
    'mf': {
        0.20: '2tensor_twoC3__J2_0p2_20260422_191618',
        0.21: '2tensor_twoC3__J2_0p21_20260422_193419',
        0.22: '2tensor_twoC3__J2_0p22_20260422_200920',
        0.23: '2tensor_twoC3__J2_0p23_20260422_214321',
        0.24: '2tensor_twoC3__J2_0p24_20260422_215920',
        0.25: '2tensor_twoC3__J2_0p25_20260422_220359',
    },
    'two': {
        0.20: '2tensor_twoC3__J2_0p2_20260422_170955',
        0.21: '2tensor_twoC3__J2_0p21_20260422_171252',
        0.22: '2tensor_twoC3__J2_0p22_20260422_171252',
        0.23: '2tensor_twoC3__J2_0p23_20260422_171252',
        0.24: '2tensor_twoC3__J2_0p24_20260422_172117',
        0.25: '2tensor_twoC3__J2_0p25_20260422_182319',
    },
    'mf1t': {
        0.20: '1tensor_C6Ypi__J2_0p2_20260422_183404',
    },
}

J2_LIST = [0.20, 0.21, 0.22, 0.23, 0.24, 0.25]

ANSATZ_STYLE = {
    'two':  dict(color='tab:blue',   ls='-',  label='vanilla 2C3',   marker='o'),
    'mf':   dict(color='tab:red',    ls='--', label='MF-init 2C3',   marker='s'),
    'mf1t': dict(color='tab:green',  ls=':',  label='MF-init 1C6π',  marker='^'),
}
