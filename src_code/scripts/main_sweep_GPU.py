...
DEFAULT_D_BUDGET_FRACS = {2: 0.1, 3: 0.5, 4: 0.4}
...
DEFAULT_CHI_SCHEDULES = {
    2: [5, 8, 12],#, 16],
    3: [10, 18, 32],       # , 57, 81],  ← append to extend the schedule
    4: [17, 26],           # , 40, 62, 80] ← append to extend the schedule
}
